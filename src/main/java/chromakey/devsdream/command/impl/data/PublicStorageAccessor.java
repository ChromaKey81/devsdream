package chromakey.devsdream.command.impl.data;
...
public class PublicStorageAccessor implements IDataAccessor {
    public static final SuggestionProvider<CommandSource> suggestions = (p_229838_0_, p_229838_1_) -> {
     ...
     public static final Function<String, DataCommand.IDataProvider> field_229833_a_ = (p_229839_0_) -> {
        return new DataCommand.IDataProvider() {
           ...
           public IDataAccessor createAccessor(CommandContext<CommandSource> context) {
              return new PublicStorageAccessor(PublicStorageAccessor.func_229840_b_(context), ResourceLocationArgument.getResourceLocation(context, p_229839_0_));
           }
           ...
           public ArgumentBuilder<CommandSource, ?> createArgument(ArgumentBuilder<CommandSource, ?> builder, Function<ArgumentBuilder<CommandSource, ?>, ArgumentBuilder<CommandSource, ?>> action) {
              return builder.then(Commands.literal("storage").then((ArgumentBuilder)action.apply(Commands.argument(p_229839_0_, ResourceLocationArgument.resourceLocation()).suggests(PublicStorageAccessor.suggestions))));
           }
        };
     };
     ...
     public PublicStorageAccessor(CommandStorage p_i226092_1_, ResourceLocation p_i226092_2_) {
