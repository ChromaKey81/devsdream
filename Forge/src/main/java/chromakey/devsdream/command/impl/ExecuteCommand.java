...
public class ExecuteCommand {
    private static final Dynamic2CommandExceptionType TOO_MANY_BLOCKS = new Dynamic2CommandExceptionType(
            (p_208885_0_, p_208885_1_) -> {
    ...
    private static final DynamicCommandExceptionType TEST_FAILED_COUNT = new DynamicCommandExceptionType(
            (p_210446_0_) -> {
                return new TranslationTextComponent("commands.execute.conditional.fail_count", p_210446_0_);
            });
    private static final BinaryOperator<ResultConsumer<CommandSource>> COMBINE_ON_RESULT_COMPLETE = (p_209937_0_,
            p_209937_1_) -> {
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher) {
        LiteralCommandNode<CommandSource> literalcommandnode = dispatcher
                .register(Commands.literal("dreamexecute").requires((p_198387_0_) -> {
                    return p_198387_0_.hasPermissionLevel(2);
                }));
        dispatcher.register(Commands.literal("dreamexecute").requires((p_229766_0_) -> {
            return p_229766_0_.hasPermissionLevel(2);
        }).then(Commands.literal("run").redirect(dispatcher.getRoot()))
                .then(makeIfCommand(literalcommandnode, Commands.literal("if"), true))
                .then(makeIfCommand(literalcommandnode, Commands.literal("unless"), false))
                .then(Commands.literal("as").then(Commands.argument("targets", EntityArgument.entities())
                        .fork(literalcommandnode, (p_198384_0_) -> {
                ...
                .then(Commands.literal("at").then(Commands.argument("targets", EntityArgument.entities())
                        .fork(literalcommandnode, (p_229809_0_) -> {
                            List<CommandSource> list = Lists.newArrayList();

                            for (Entity entity : EntityArgument.getEntitiesAllowingNone(p_229809_0_, "targets")) {
                                list.add(p_229809_0_.getSource().withWorld((ServerWorld) entity.world)
                                        .withPos(entity.getPositionVec()).withRotation(entity.getPitchYaw()));
                            }

                            return list;
                        })))
                .then(Commands.literal("store")
                        .then(makeStoreSubcommand(literalcommandnode, Commands.literal("result"), true))
                        .then(makeStoreSubcommand(literalcommandnode, Commands.literal("success"), false)))
                .then(Commands.literal("positioned").then(
                        Commands.argument("pos", Vec3Argument.vec3()).redirect(literalcommandnode, (p_229808_0_) -> {
                            return p_229808_0_.getSource().withPos(Vec3Argument.getVec3(p_229808_0_, "pos"))
                                    .withEntityAnchorType(EntityAnchorArgument.Type.FEET);
                        })).then(Commands.literal("as").then(Commands.argument("targets", EntityArgument.entities())
                                .fork(literalcommandnode, (p_229807_0_) -> {
                                    List<CommandSource> list = Lists.newArrayList();

                                    for (Entity entity : EntityArgument.getEntitiesAllowingNone(p_229807_0_,
                                            "targets")) {
                ...
                .then(Commands.literal("rotated").then(Commands.argument("rot", RotationArgument.rotation())
                        .redirect(literalcommandnode, (p_229806_0_) -> {
                            return p_229806_0_.getSource().withRotation(RotationArgument.getRotation(p_229806_0_, "rot")
                                    .getRotation(p_229806_0_.getSource()));
                        })).then(Commands.literal("as").then(Commands.argument("targets", EntityArgument.entities())
                                .fork(literalcommandnode, (p_201083_0_) -> {
                                    List<CommandSource> list = Lists.newArrayList();

                                    for (Entity entity : EntityArgument.getEntitiesAllowingNone(p_201083_0_,
                                            "targets")) {
                ...
                .then(Commands.literal("facing")
                        .then(Commands.literal("entity")
                                .then(Commands.argument("targets", EntityArgument.entities())
                                        .then(Commands.argument("anchor", EntityAnchorArgument.entityAnchor())
                                                .fork(literalcommandnode, (p_229805_0_) -> {
                                                    List<CommandSource> list = Lists.newArrayList();
                                                    EntityAnchorArgument.Type entityanchorargument$type = EntityAnchorArgument
                                                            .getEntityAnchor(p_229805_0_, "anchor");

                                                    for (Entity entity : EntityArgument
                                                            .getEntitiesAllowingNone(p_229805_0_, "targets")) {
                                                        list.add(p_229805_0_.getSource().withRotation(entity,
                                                                entityanchorargument$type));
                                                    }

                                                    return list;
                                                }))))
                        .then(Commands.argument("pos", Vec3Argument.vec3()).redirect(literalcommandnode,
                                (p_198381_0_) -> {
                                    return p_198381_0_.getSource()
                                            .withRotation(Vec3Argument.getVec3(p_198381_0_, "pos"));
                                })))
                .then(Commands.literal("align").then(Commands.argument("axes", SwizzleArgument.swizzle())
                        .redirect(literalcommandnode, (p_201091_0_) -> {
                            return p_201091_0_.getSource().withPos(p_201091_0_.getSource().getPos()
                                    .align(SwizzleArgument.getSwizzle(p_201091_0_, "axes")));
                        })))
                .then(Commands.literal("anchored").then(Commands.argument("anchor", EntityAnchorArgument.entityAnchor())
                        .redirect(literalcommandnode, (p_201089_0_) -> {
                            return p_201089_0_.getSource()
                                    .withEntityAnchorType(EntityAnchorArgument.getEntityAnchor(p_201089_0_, "anchor"));
                        })))
                .then(Commands.literal("in").then(Commands.argument("dimension", DimensionArgument.getDimension())
                        .redirect(literalcommandnode, (p_229804_0_) -> {
                            return p_229804_0_.getSource()
                                    .withWorld(DimensionArgument.getDimensionArgument(p_229804_0_, "dimension"));
                        }))));
    }

    private static ArgumentBuilder<CommandSource, ?> makeStoreSubcommand(LiteralCommandNode<CommandSource> parent,
            LiteralArgumentBuilder<CommandSource> literal, boolean storingResult) {
        literal.then(Commands.literal("score").then(Commands.argument("targets", ScoreHolderArgument.scoreHolders())
                ...
                .then(Commands.argument("objective", ObjectiveArgument.objective()).redirect(parent, (p_201468_1_) -> {
                    return storeIntoScore(p_201468_1_.getSource(),
        ...
        literal.then(Commands.literal("bossbar")
                .then(Commands.argument("id", ResourceLocationArgument.resourceLocation())
                        ...
                        .then(Commands.literal("value").redirect(parent, (p_201457_1_) -> {
                            return storeIntoBossbar(p_201457_1_.getSource(), BossBarCommand.getBossbar(p_201457_1_),
                                    true, storingResult);
                        })).then(Commands.literal("max").redirect(parent, (p_229795_1_) -> {
                            return storeIntoBossbar(p_229795_1_.getSource(), BossBarCommand.getBossbar(p_229795_1_),
                                    false, storingResult);
                        }))));
        ...
        for (DataCommand.IDataProvider datacommand$idataprovider : DataCommand.field_218955_b) {
            datacommand$idataprovider.createArgument(literal, (p_229765_3_) -> {
                return p_229765_3_.then(
                        Commands.argument("path", NBTPathArgument.nbtPath()).then(Commands.literal("int").then(Commands
                                .argument("scale", DoubleArgumentType.doubleArg()).redirect(parent, (p_229801_2_) -> {
                                    return storeIntoNBT(p_229801_2_.getSource(),
                                            datacommand$idataprovider.createAccessor(p_229801_2_),
                                            NBTPathArgument.getNBTPath(p_229801_2_, "path"), (p_229800_1_) -> {
                                                return IntNBT.valueOf((int) ((double) p_229800_1_
                                                        * DoubleArgumentType.getDouble(p_229801_2_, "scale")));
                                            }, storingResult);
                                })))
                                .then(Commands.literal("float")
                                        .then(Commands.argument("scale", DoubleArgumentType.doubleArg())
                                                .redirect(parent, (p_229798_2_) -> {
                                                    return storeIntoNBT(p_229798_2_.getSource(),
                                                            datacommand$idataprovider.createAccessor(p_229798_2_),
                                                            NBTPathArgument.getNBTPath(p_229798_2_, "path"),
                                                            (p_229797_1_) -> {
                                                                return FloatNBT.valueOf((float) ((double) p_229797_1_
                                                                        * DoubleArgumentType.getDouble(p_229798_2_,
                                                                                "scale")));
                                                            }, storingResult);
                                                })))
                                .then(Commands.literal("short")
                                        .then(Commands.argument("scale", DoubleArgumentType.doubleArg())
                                                .redirect(parent, (p_229794_2_) -> {
                                                    return storeIntoNBT(p_229794_2_.getSource(),
                                                            datacommand$idataprovider.createAccessor(p_229794_2_),
                                                            NBTPathArgument.getNBTPath(p_229794_2_, "path"),
                                                            (p_229792_1_) -> {
                                                                return ShortNBT
                                                                        .valueOf((short) ((int) ((double) p_229792_1_
                                ...
                                .then(Commands.literal("long")
                                        .then(Commands.argument("scale", DoubleArgumentType.doubleArg())
                                                .redirect(parent, (p_229790_2_) -> {
                                                    return storeIntoNBT(p_229790_2_.getSource(),
                                                            datacommand$idataprovider.createAccessor(p_229790_2_),
                                                            NBTPathArgument.getNBTPath(p_229790_2_, "path"),
                                                            (p_229788_1_) -> {
                                                                return LongNBT.valueOf((long) ((double) p_229788_1_
                                                                        * DoubleArgumentType.getDouble(p_229790_2_,
                                                                                "scale")));
                                                            }, storingResult);
                                                })))
                                .then(Commands.literal("double")
                                        .then(Commands.argument("scale", DoubleArgumentType.doubleArg())
                                                .redirect(parent, (p_229784_2_) -> {
                                                    return storeIntoNBT(p_229784_2_.getSource(),
                                                            datacommand$idataprovider.createAccessor(p_229784_2_),
                                                            NBTPathArgument.getNBTPath(p_229784_2_, "path"),
                                                            (p_229781_1_) -> {
                                                                return DoubleNBT.valueOf(
                                                                        (double) p_229781_1_ * DoubleArgumentType
                                                                                .getDouble(p_229784_2_, "scale"));
                                                            }, storingResult);
                                                })))
                                .then(Commands.literal("byte")
                                        .then(Commands.argument("scale", DoubleArgumentType.doubleArg())
                                                .redirect(parent, (p_229774_2_) -> {
                                                    return storeIntoNBT(p_229774_2_.getSource(),
                                                            datacommand$idataprovider.createAccessor(p_229774_2_),
                                                            NBTPathArgument.getNBTPath(p_229774_2_, "path"),
                                                            (p_229762_1_) -> {
                                                                return ByteNBT
                                                                        .valueOf((byte) ((int) ((double) p_229762_1_
                                                                                * DoubleArgumentType.getDouble(
                                                                                        p_229774_2_, "scale"))));
                                                            }, storingResult);
                                                }))));
    ...
    private static CommandSource storeIntoScore(CommandSource source, Collection<String> targets,
            ScoreObjective objective, boolean storingResult) {
    ...
    private static CommandSource storeIntoBossbar(CommandSource source, CustomServerBossInfo bar, boolean storingValue,
    ...
    private static CommandSource storeIntoNBT(CommandSource source, IDataAccessor accessor,
            NBTPathArgument.NBTPath pathIn, IntFunction<INBT> tagConverter, boolean storingResult) {
    ...
    private static ArgumentBuilder<CommandSource, ?> makeIfCommand(CommandNode<CommandSource> parent,
            LiteralArgumentBuilder<CommandSource> literal, boolean isIf) {
        literal.then(Commands.literal("block")
                .then(Commands.argument("pos", BlockPosArgument.blockPos()).then(buildIfResult(parent,
                        Commands.argument("block", BlockPredicateArgument.blockPredicate()), isIf, (p_210438_0_) -> {
                            return BlockPredicateArgument.getBlockPredicate(p_210438_0_, "block")
                                    .test(new CachedBlockInfo(p_210438_0_.getSource().getWorld(),
                                            BlockPosArgument.getLoadedBlockPos(p_210438_0_, "pos"), true));
                        }))))
                .then(Commands.literal("score").then(Commands.argument("target", ScoreHolderArgument.scoreHolder())
                        .suggests(ScoreHolderArgument.SUGGEST_ENTITY_SELECTOR)
                        .then(Commands.argument("targetObjective", ObjectiveArgument.objective()).then(Commands
                                .literal("=")
                                .then(Commands.argument("source", ScoreHolderArgument.scoreHolder())
                                        .suggests(ScoreHolderArgument.SUGGEST_ENTITY_SELECTOR)
                                        .then(buildIfResult(parent,
                                                Commands.argument("sourceObjective", ObjectiveArgument.objective()),
                                                isIf, (p_229803_0_) -> {
                                                    return compareScores(p_229803_0_, Integer::equals);
                                                }))))
                                .then(Commands.literal("<").then(Commands
                                        .argument("source", ScoreHolderArgument.scoreHolder())
                                        .suggests(ScoreHolderArgument.SUGGEST_ENTITY_SELECTOR)
                                        .then(buildIfResult(parent,
                                                Commands.argument("sourceObjective", ObjectiveArgument.objective()),
                                                isIf, (p_229802_0_) -> {
                                ...
                                .then(Commands.literal("matches").then(buildIfResult(parent,
                                        Commands.argument("range", IRangeArgument.intRange()), isIf, (p_229787_0_) -> {
                                            return checkScore(p_229787_0_,
                                                    IRangeArgument.IntRange.getIntRange(p_229787_0_, "range"));
                                        }))))))
                        ...
                        .then(Commands.argument("start", BlockPosArgument.blockPos())
                                .then(Commands.argument("end", BlockPosArgument.blockPos())
                                        .then(Commands.argument("destination", BlockPosArgument.blockPos())
                                                .then(buildIfBlocks(parent, Commands.literal("all"), isIf, false))
                                                .then(buildIfBlocks(parent, Commands.literal("masked"), isIf, true))))))
                .then(Commands.literal("entity")
                        .then(Commands.argument("entities", EntityArgument.entities()).fork(parent, (p_229791_1_) -> {
                            return checkIfMatches(p_229791_1_, isIf,
                                    !EntityArgument.getEntitiesAllowingNone(p_229791_1_, "entities").isEmpty());
                ...
                .then(Commands.literal("predicate")
                        .then(buildIfResult(parent,
                                Commands.argument("predicate", ResourceLocationArgument.resourceLocation())
                                        .suggests(field_229760_e_),
                                isIf, (p_229761_0_) -> {
                                    return func_229767_a_(p_229761_0_.getSource(),
                                            ResourceLocationArgument.func_228259_c_(p_229761_0_, "predicate"));
                                })));
        ...
        for (DataCommand.IDataProvider datacommand$idataprovider : DataCommand.field_218956_c) {
            literal.then(datacommand$idataprovider.createArgument(Commands.literal("data"), (p_229764_3_) -> {
                return p_229764_3_
                        .then(Commands.argument("path", NBTPathArgument.nbtPath()).fork(parent, (p_229777_2_) -> {
                            return checkIfMatches(p_229777_2_, isIf,
                                    func_218831_a(datacommand$idataprovider.createAccessor(p_229777_2_),
                                            NBTPathArgument.getNBTPath(p_229777_2_, "path")) > 0);
                        }).executes(func_218834_a(isIf, (p_229773_1_) -> {
                            return func_218831_a(datacommand$idataprovider.createAccessor(p_229773_1_),
                                    NBTPathArgument.getNBTPath(p_229773_1_, "path"));
                        })));
            }));
        }
    ...
    private static Command<CommandSource> func_218834_a(boolean p_218834_0_, ExecuteCommand.INumericTest p_218834_1_) {
        return p_218834_0_ ? (p_229783_1_) -> {
            ...
            if (i > 0) {
                p_229783_1_.getSource().sendFeedback(
                        new TranslationTextComponent("commands.execute.conditional.pass_count", i), false);
                return i;
            } else {
            ...
            if (i == 0) {
                p_229771_1_.getSource().sendFeedback(new TranslationTextComponent("commands.execute.conditional.pass"),
                        false);
                return 1;
            } else {
    ...
    private static int func_218831_a(IDataAccessor p_218831_0_, NBTPathArgument.NBTPath p_218831_1_)
            throws CommandSyntaxException {
        return p_218831_1_.func_218069_b(p_218831_0_.getData());
    }

    private static boolean compareScores(CommandContext<CommandSource> context,
            BiPredicate<Integer, Integer> comparison) throws CommandSyntaxException {
    ...
    private static boolean checkScore(CommandContext<CommandSource> context, MinMaxBounds.IntBound bounds)
            throws CommandSyntaxException {
        String s = ScoreHolderArgument.getSingleScoreHolderNoObjectives(context, "target");
        ScoreObjective scoreobjective = ObjectiveArgument.getObjective(context, "targetObjective");
        Scoreboard scoreboard = context.getSource().getServer().getScoreboard();
        return !scoreboard.entityHasObjective(s, scoreobjective) ? false
                : bounds.test(scoreboard.getOrCreateScore(s, scoreobjective).getScorePoints());
    }
    ...
    /**
     * If actual and expected match, returns a collection containing only the source
     * player.
     */
    private static Collection<CommandSource> checkIfMatches(CommandContext<CommandSource> context, boolean actual,
            boolean expected) {
        return (Collection<CommandSource>) (expected == actual ? Collections.singleton(context.getSource())
                : Collections.emptyList());
    }

    private static ArgumentBuilder<CommandSource, ?> buildIfResult(CommandNode<CommandSource> context,
            ArgumentBuilder<CommandSource, ?> builder, boolean value, ExecuteCommand.IBooleanTest test) {
        return builder.fork(context, (p_229786_2_) -> {
            ...
            if (value == test.test(p_229776_2_)) {
                p_229776_2_.getSource().sendFeedback(new TranslationTextComponent("commands.execute.conditional.pass"),
                        false);
                return 1;
            } else {
                throw TEST_FAILED.create();
    ...
    private static ArgumentBuilder<CommandSource, ?> buildIfBlocks(CommandNode<CommandSource> parent,
            ArgumentBuilder<CommandSource, ?> literal, boolean isIf, boolean isMasked) {
    ...
    private static int checkBlockCountIf(CommandContext<CommandSource> context, boolean isMasked)
            throws CommandSyntaxException {
        OptionalInt optionalint = countMatchingBlocks(context, isMasked);
        if (optionalint.isPresent()) {
            context.getSource().sendFeedback(
                    new TranslationTextComponent("commands.execute.conditional.pass_count", optionalint.getAsInt()),
                    false);
    ...
    private static int checkBlockCountUnless(CommandContext<CommandSource> context, boolean isMasked)
            throws CommandSyntaxException {
        OptionalInt optionalint = countMatchingBlocks(context, isMasked);
        if (optionalint.isPresent()) {
    ...
    private static OptionalInt countMatchingBlocks(CommandContext<CommandSource> context, boolean isMasked)
            throws CommandSyntaxException {
        return countMatchingBlocks(context.getSource().getWorld(), BlockPosArgument.getLoadedBlockPos(context, "start"),
                BlockPosArgument.getLoadedBlockPos(context, "end"),
                BlockPosArgument.getLoadedBlockPos(context, "destination"), isMasked);
    }

    private static OptionalInt countMatchingBlocks(ServerWorld worldIn, BlockPos begin, BlockPos end,
            BlockPos destination, boolean isMasked) throws CommandSyntaxException {
        MutableBoundingBox mutableboundingbox = new MutableBoundingBox(begin, end);
        MutableBoundingBox mutableboundingbox1 = new MutableBoundingBox(destination,
                destination.add(mutableboundingbox.getLength()));
        BlockPos blockpos = new BlockPos(mutableboundingbox1.minX - mutableboundingbox.minX,
                mutableboundingbox1.minY - mutableboundingbox.minY, mutableboundingbox1.minZ - mutableboundingbox.minZ);
